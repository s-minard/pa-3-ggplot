...
> Species, Island, Bill Length mm, Bill Depth mm, Flipper Length mm, Body Mass gm, Sex, Year data gathered. The data is measured in milimeters and grams. Each row represents one penguin. 
...
ggplot(data = penguins) +
  ...
  labs(x = "penguin species",
       ...
       title = "number of penguins of each species in the sample")
```
...
ggplot(data = penguins) +
  ...
  labs(x = "bill length mm",
       y = "bill depth mm",
       title = "penguin bill length by bill depth")
```
...
Chinstrap is the least represented species in the data set.
